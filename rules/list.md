...
общение в торговой площадке, использование команд. Наказания выдаются ПОСЛЕ того, как модератор предупредил человека об этом соответствующим нотом ".оффтоп" или устно.
```
```Наказание:
